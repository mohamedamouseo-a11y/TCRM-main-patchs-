...
PATCH_ID = "FELFEL-UXUI-REFERENCE-DESIGN-V3"
...
# Hero surface and spacing.
text = replace_once(text, 'data-felfel-uxui="premium-v1"', 'data-felfel-uxui="reference-v3"', "design marker")
text = replace_once(
    text,
...
# Avatar: an outer decorative circle and a separate clipped inner circle keep the photo truly inside.
...
# Tabs: raised active tab with an orange lower edge, using only stable Tailwind selectors.
...
# New Meeting visual hierarchy and CTA.
text = replace_once(
    text,
...
# Four summary cards under Live Meeting.
