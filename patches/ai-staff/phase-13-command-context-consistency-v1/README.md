...
Tara receives a live Current Workspace badge alongside its existing campaign/global scope badge while preserving `initialTab` behavior and all Control Center functionality.
