...
PATCH = 'TCRM-PERMISSIONS-WHATSAPP-API-V1'
...
# ---------------------------------------------------------------------------
# 1) Central WhatsApp / WA Gateway permission mapping.
#    Reads -> whatsapp.view.
#    Normal operator actions -> whatsapp.send.
#    Admin/config + any unknown future operation -> whatsapp.manage fail-closed.
#    Existing account/chat/service scope checks remain additive and untouched.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 2) Regression test current operator endpoints and fail-closed admin/unknowns.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 3) Static post-checks. No router/client/CSS/DB/data changes.
# ---------------------------------------------------------------------------
checks = {
